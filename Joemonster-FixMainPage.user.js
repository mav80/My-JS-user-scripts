...
(function() {
    ...
    //This part hides article named "Ciekawe wątki na forach JM"
    ...
    [].slice.call(document.querySelectorAll('a'), 0).forEach(function(aEl) {
        // if the text of the aEl Node contains the text 'Ciekawe wątki na forach JM':
        if (aEl[textProp].indexOf('Ciekawe wątki na forach JM') > -1) {
            // we update its style:
